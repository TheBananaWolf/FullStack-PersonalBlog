<template>
  <el-card>
    <h1 class="me-author-name">蕉太狼</h1>
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;新加坡</span>
      <span><i class="me-icon-job"></i> &nbsp;NTU SCSE Master</span>
    </div>
    <div class="me-author-tool">
      ...
      <i @click="showTool(weibo)" :title="weibo.title" class="iconfont icon-weibo"></i>
